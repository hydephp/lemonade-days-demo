...
<nav aria-label="Main navigation" id="main-navigation" @class([
    ...
    <div class="block md:hidden">
        <button id="navigation-toggle-button" class="flex items-center px-3 py-1 hover:text-charcoal/70"
            ...
            <svg x-show="! navigationOpen" title="Open Navigation Menu" class="fill-charcoal"
                 style="display: block;"
            ...
            <svg x-show="navigationOpen" title="Close Navigation Menu" class="fill-charcoal" style="display: none;"
    ...
    <div id="main-navigation-links"
         class="w-full hidden md:flex grow md:grow-0 md:items-center md:w-auto px-6 -mx-4 border-t mt-3 pt-3 md:border-none md:mt-0 md:py-0 border-charcoal/20"
