<article aria-label="Article" id="{{ $page->identifier }}" itemscope itemtype="https://schema.org/BlogPosting"
    @class(['post-article mx-auto', config('markdown.prose_classes', 'prose')])>
    ...
    <header aria-label="Header section" role="doc-pageheader">
        <h1 itemprop="headline" class="mb-4 font-serif">{{ $page->title }}</h1>
        <div id="byline" aria-label="About the post" role="doc-introduction" class="text-charcoal/70 not-prose">
